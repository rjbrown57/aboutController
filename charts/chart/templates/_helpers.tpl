...
*/}}
{{- define "aboutcontroller.fullname" -}}
...
*/}}
{{- define "aboutcontroller.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "aboutcontroller.resourceName" -}}
{{- $fullname := include "aboutcontroller.fullname" .context }}
{{- $suffix := .suffix }}
